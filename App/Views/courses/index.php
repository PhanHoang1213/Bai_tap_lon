                    ...
                    <div class="course__about-knowledge">
                        ...
                        <ul class="course__about-knowledge-list">
                            ...
                            <!-- <li class="course__about-knowledge-item">
                                ...
                                <span class="course__about-knowledge-desc text">Các khái niệm, thuật ngữ cốt lõi
                                    khi
                                    triển
                                    khai
                                    ứng dụng</span>
                            ...
                            <li class="course__about-knowledge-item">
                                ...
                                <span class="course__about-knowledge-desc text">Các mô hình, kiến trúc cơ bản
                                    khi
                                    triển
                                    khai ứng
                                    dụng</span>
                            ...
                            <li class="course__about-knowledge-item">
                                ...
                                <span class="course__about-knowledge-desc text">Hiểu hơn về cách internet và máy
                                    vi
                                    tính
                                    hoạt
                                    động</span>
